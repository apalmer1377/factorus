...
let g:factorus_tag_query = '^\s*' . s:access_query . '\(class\_s*\|enum\_s*\|' . g:factorus_java_identifier . s:collection_identifier . '\=\_s\+' . g:factorus_java_identifier . s:collection_identifier . '\=' . g:remainder_query . '(\)'
